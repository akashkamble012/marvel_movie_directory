        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Text(controller.authType == AuthType.signUp ?  'Sign Up' : 'Sign In', style: Styles., ),
              // Styles.sizedBoxW20,
              InputBoxFill(
                labelText: 'Email',
              ...
              CustomElevatedButton(
                buttonName: controller.authType == AuthType.signUp
                    ? 'SIGN UP'
                    : 'SIGN IN',
                onPressed: () {
                  ...
                  controller.authType == AuthType.signUp
